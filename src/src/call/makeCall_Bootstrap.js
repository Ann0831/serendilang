...
import { hideStartOverlay } from "../pages/callPage.js";
...
function initCallActionButtons() {
  ...
  const cancelBtn = document.getElementById("dialingOverlay-Buttontext");
  if (cancelBtn) {
    cancelBtn.addEventListener("click", () => {
      try {
        controller.cancelCallRequest();
      } catch (err) {
        console.error("cancel call request failed:", err);
      }
    });
  }
