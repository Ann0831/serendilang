...
import { postSendPostReport, postSendReportUser } from "../api/post_api.client.js";
import { getMyPostReports } from "../api/api.client.js";
...
export async function reportPostService(postId, reason) {
  ...
  try {
    ...
    handleServiceNetworkError(err, "reportService.js");
