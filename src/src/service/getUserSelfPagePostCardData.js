...
export async function getUserSelfPagePostCardData(post_id) {
  try {
    ...
    if (profileSettled.status === "rejected") handleServiceNetworkError(profileSettled.reason, "getUserSelfPagePostCardData.js");
    if (langSettled.status === "rejected") handleServiceNetworkError(langSettled.reason, "getUserSelfPagePostCardData.js");
    if (likeSettled.status === "rejected") handleServiceNetworkError(likeSettled.reason, "getUserSelfPagePostCardData.js");
    ...
    handleServiceNetworkError(err, "getUserSelfPagePostCardData.js");
