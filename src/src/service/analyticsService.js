import {postApiAnalyticsIceDisconnected, postAnalyticsFirstOnlineList,postAnalyticsWssDisconnect } from "../api/post_api.client.js";
...
export async function recordFirstOnlineList(onlineList,place) {
  try {
    ...
    handleServiceNetworkError(err, "analyticsService.js");
