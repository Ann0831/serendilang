...
import { registerSelfPostMenuHandlers } from "./handlers/selfPostMenu.js";
...
import { registerPageLoadHandlers } from "./handlers/pageLoad.js";

// Online users（清單廣播、排序）
import { registerOnlineUsersHandlers } from "./handlers/onlineUsers.js";

// Chat room（開關、滾動、訊息送出/同步、選單）
import { registerChatRoomHandlers } from "./handlers/chatRoom.js";

// Calling（語音/視訊、來電提示、接受/拒絕）
import { registerCallHandlers } from "./handlers/calling.js";

// Post Modal（發文）
import { registerPostModalHandlers } from "./handlers/createPost.js";

// Post Actions（按讚、主頁選單、檢舉貼文、刪文、自介頁選單、開使用者頁）
import { registerPostActionsHandlers } from "./handlers/postActions.js";

// Friend requests（送出/接受）
import { registerFriendRequestHandlers } from "./handlers/friendRequests.js";

// Report user（檢舉使用者）
import { registerReportUserHandlers } from "./handlers/reportUser.js";

// Delete account（刪除帳號）
import { registerDeleteAccountHandlers } from "./handlers/deleteAccount.js";

// User block / unblock / blocked list
import { registerUserBlockHandlers } from "./handlers/userBlock.js";

// Edit UserData modal
import { registerUserSelfModalHandlers } from "./handlers/editUserDataModal.js";
